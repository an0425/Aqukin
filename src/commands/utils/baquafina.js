...
module.exports = class BaquafinaCommand extends BaseCommand{
    constructor() {super("baquafina", ["pure", "aquafina", "bakafina", "aqukinfina"], "Display randomly one of the Baquafina(?) pictures", "SEND_MESSAGES", "utility", false, false, "", "-- will display a Baquafina(?) picture")}
