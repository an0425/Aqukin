...
module.exports = class LiveInfoCommand extends BaseCommand{
    constructor() {super("liveinfo", ["li", "live", "streaming"], "Check the live status of a youtube channel", "SEND_MESSAGES", "utility", true, "<channel name/URL>", "Aqua ch. -- will search youtube for the 1st channel matches the argument & display their live status")}
