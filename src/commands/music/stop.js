...
module.exports = class StopCommand extends BaseCommand{
    constructor() {super("stop",["disconnect", "dc", "leave"], "CONNECT", "music", false, "")}
    ...
    async run (para) {
      ...
      if(members.size > 1 && !msg.member.hasPermission("ADMINISTRATOR")) {return msg.channel.send(`**${msg.author.username}**-sama, you neeed to either be alone with Aqukin or has Administrative permission to use this command!`)}
