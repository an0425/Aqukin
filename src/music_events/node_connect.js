...
module.exports = class NodeConnectEvent extends BaseEvent {
	...
	async run (music, node){
		music.votingSystem = new Collection(); // a collection for voting
		music.thumbnails = ["https://media1.tenor.com/images/5144c642df05176d7f20be7d291274b7/tenor.gif?itemid=15931764",
